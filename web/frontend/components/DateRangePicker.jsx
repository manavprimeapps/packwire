...
export function DateRangePicker({ SelectedDate }) {
  ...
  if (SelectedDate) {
    useEffect(() => {
      SelectedDate(inputValues);
    }, [inputValues]);
  }

  const buttonValue =
    activeDateRange.title === 'Custom'
      ? activeDateRange.period.since.toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' }) +
        ' - ' +
        activeDateRange.period.until.toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' })
      ...
      <Popover.Pane fixed>
        ...
        >
          ...
          <Box padding={{ xs: 500 }} maxWidth={mdDown ? '320px' : '516px'}>
            <BlockStack gap="400">
              <div className="datepicker_inputeselcter" gap="200">
